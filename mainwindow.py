...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cb_clean = QtWidgets.QCheckBox(self.centralwidget)
        self.cb_clean.setChecked(True)
        self.cb_clean.setObjectName("cb_clean")
        self.mwLayout.addWidget(self.cb_clean)
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.mwLayout.addLayout(self.horizontalLayout_5)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cb_clean.setText(_translate("MainWindow", "Очищать каждый раз?"))
